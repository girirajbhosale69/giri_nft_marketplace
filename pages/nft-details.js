...
const NFTDetails = () => {
  ...
  return (
    <div className="relative flex justify-center md:flex-col min-h-screen">
      <div className="relative flex-1 flexCetner sm:px-4 p-12 border-r md:r-0 md:border-b dark:border-nft-black-1 border-nft-gray-1">
            ...
            ? (
              ...
              ? (
                <Button
                  ...
                  calssStyles="mr-5 sm:mr-0 sm:mb-5 rounded-xl"
      ...
      <Modal
        ...
        footer={(
          <div className="flex flex-row sm:flex-col">
            <Button
              btnName="Checkout"
              calssStyles="mr-5 sm:mb-5 sm:mr-0 rounded-xl"
              handleClick={checkout}
            />
            <Button
              btnName="Cancel"
              calssStyles="rounded-xl"
      ...
      <Modal
        ...
        body={(
          <div className="flexCenter flex-col text-center" onClick={() => setSuccessModal(false)}>
            ...
            <p className="font-poppins dark:text-white text-nft-black-1 text-sm minlg:text-xl font-normal mt-10">You successfully purchased <span className="font-semibold">{ nft.name }</span> from <span className="font-semibold">{ shortenAddress(nft.seller) }</span>
            </p>
          </div>
        )}
        footer={(
          <div className="flexCenter flex-col">
            <Button
              ...
              calssStyles="sm:mb-5 sm:mr-0 rounded-xl"
